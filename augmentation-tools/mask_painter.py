...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Paint a freehand mask for object removal."
    )
...
def main() -> int:
    ...
    state = PaintState(image, scale, args.brush)
    ...
    window = (
        "Mask Painter (MMB/Shift+LMB paint, RMB erase, Ctrl+LMB pan, +/- zoom)"
    )
